...
📱 App Overview
A Kotlin Android app that helps small vendors in village weekly markets (Santes) price their goods fairly and profitably, based on real city Mandi prices.
...
File → Open → Select the SantePriceIndex folder
...
Add an Android app with package: com.sante.priceindex
Download google-services.json → place in app/ folder
Uncomment Firebase lines in app/build.gradle:
id 'com.google.gms.google-services'
// ...
implementation platform('com.google.firebase:firebase-bom:32.7.0')
implementation 'com.google.firebase:firebase-database-ktx'
In MandiRepository.kt, replace fetchTodayPrices() with the Firebase snippet shown in the comments
...
🛠️ Troubleshooting
Build error: "Unresolved reference: MPAndroidChart" → Make sure JitPack is in settings.gradle repositories (already included)

Navigation not working → Ensure fragment IDs in nav_graph.xml match menu item IDs in bottom_nav_menu.xml

Price Board not going fullscreen → Test on a physical device; emulator may not hide navigation bar fully
